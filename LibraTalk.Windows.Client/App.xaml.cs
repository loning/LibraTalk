...
using LibraTalk.Windows.Client.Bootstraps;
using LibraTalk.Windows.Client.Views;
using StartupPage = LibraTalk.Windows.Client.Views.StartupPage;

namespace LibraTalk.Windows.Client
{
    /// <summary>
    ...
    {
        internal ApplicationExecutionState PreviousExecutionState
        {
            get;
            private set;
        }
