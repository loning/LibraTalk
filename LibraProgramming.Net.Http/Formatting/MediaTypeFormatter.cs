...
namespace LibraProgramming.Net.Http.Formatting
{
    /// <summary>
    ...
    public abstract class MediaTypeFormatter
    {
        ...
        private static readonly ConcurrentDictionary<Type, ConstructorInfo> _delegatingEnumerableConstructorCache = new ConcurrentDictionary<Type, ConstructorInfo>();
        private static readonly Lazy<int> _defaultMaxHttpCollectionKeys = new Lazy<int>(InitializeDefaultCollectionKeySize, true); // Max number of keys is 1000
        ...
        {
            SupportedMediaTypesInternal = new List<MediaTypeHeaderValue>();
            SupportedMediaTypes = new MediaTypeHeaderValueCollection(SupportedMediaTypesInternal);
            SupportedEncodingsInternal = new List<Encoding>();
            SupportedEncodings = new Collection<Encoding>(SupportedEncodingsInternal);
        ...
        protected MediaTypeFormatter(MediaTypeFormatter formatter)
        {
            ...
            SupportedMediaTypesInternal = formatter.SupportedMediaTypesInternal;
            SupportedMediaTypes = formatter.SupportedMediaTypes;
            SupportedEncodingsInternal = formatter.SupportedEncodingsInternal;
        ...
        /// <summary>
        /// This method converts <see cref="IQueryable"/> (and interfaces that mandate it) to a <see cref="DelegatingEnumerable{T}"/> for serialization purposes.
        /// </summary>
        /// <param name="type">The type to potentially be wrapped. If the type is wrapped, it's changed in place.</param>
        /// <returns>Returns <c>true</c> if the type was wrapped; <c>false</c>, otherwise</returns>
        ...
        public Encoding SelectCharacterEncoding(HttpContentHeaders contentHeaders)
        {
            ...
            if (contentHeaders != null && contentHeaders.ContentType != null)
            {
                ...
                if (!String.IsNullOrWhiteSpace(charset))
                {
                    ...
                    {
                        Encoding supportedEncoding = SupportedEncodingsInternal[i];
            ...
            if (encoding == null)
            {
                ...
                {
                    encoding = SupportedEncodingsInternal[0];
                }
            }
        ...
        public virtual void SetDefaultContentHeaders(Type type, HttpContentHeaders headers, MediaTypeHeaderValue mediaType)
        {
            ...
            if (headers.ContentType == null)
            {
                ...
                {
                    defaultMediaType = SupportedMediaTypesInternal[0];
                }
            ...
            if (headers.ContentType != null && headers.ContentType.CharSet == null)
            {
                ...
                if (SupportedEncodingsInternal.Count > 0)
                {
                    defaultEncoding = SupportedEncodingsInternal[0];
                }
