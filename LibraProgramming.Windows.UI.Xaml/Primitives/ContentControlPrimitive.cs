...
{
    public class ContentControlPrimitive : ContentControl
    {
        ...
        public ContentControlPrimitive()
        {
            Loaded += OnLoaded;
            Unloaded += OnUnloaded;
        ...
        static ContentControlPrimitive()
        {
            IsFocusedProperty = DependencyProperty
                .Register(
                    "IsFocused",
                    typeof (bool),
                    typeof (ContentControlPrimitive),
        ...
        {
            var control = (ContentControlPrimitive) source;
            control.UpdateVisualState(control.IsLoaded);
        }

        private class DisposableUpdateLocker : IDisposable
        {
            private readonly ContentControlPrimitive owner;

            public DisposableUpdateLocker(ContentControlPrimitive owner)
            {
                this.owner = owner;
            }
